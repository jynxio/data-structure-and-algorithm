...
async function translate() {
    ...
    const md_path = readlineSync.question( `\nThe program will translate a .md file into a .html file.\nPlease enter the path to the .md file (eg ./a.md): ` );
    const html_path = readlineSync.question( `Please enter the path to the .html file (eg ./a.html): ` );
    const is_confirm = readlineSync.question( "Are you sure? (y/n)\nPlease enter: " )

    if ( is_confirm !== "y" ) return;
            ...
            let html_content = `
                ...
                <html lang="zh-CN">
                    <head>
                        ...
                        <script src="/style/page/index.js" defer="defer"></script>
